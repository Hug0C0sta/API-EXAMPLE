package com.hugo.costa.unittests.mapper;
...
import com.hugo.costa.unittests.mapper.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseVOToEntityTest() {
        Person output = (Person) DozerMapper.parseObject(inputObject.mockVO(), Person.class);
